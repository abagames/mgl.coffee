...
Display = (function() {
  ...
  Display.beginCapture = function(scale, durationSec, intervalSec) {
    ...
    this.isCaptured = [];
    for (i = l = 1, ref = this.captureDuration; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
  ...
  Display.endCapture = function() {
    var binaryGif, encoder, i, idx, l, ref;
...
Actor = (function() {
  ...
  Actor.sc = function(targetClasses, ox, oy, minX, maxX, minY, maxY) {
    var a, actors, l, len, results, tc, tcs;
    if (oy == null) {
      oy = 0;
    }
    if (minX == null) {
    ...
    results = [];
    for (l = 0, len = tcs.length; l < len; l++) {
      tc = tcs[l];
      actors = this.s(tc);
      results.push((function() {
        var len1, m, results1;
        results1 = [];
        for (m = 0, len1 = actors.length; m < len1; m++) {
          a = actors[m];
          a.p.x += ox;
          a.p.y += oy;
          if (minX < maxX) {
          ...
          if (minY < maxY) {
            results1.push(a.p.y = a.p.y.lr(minY, maxY));
          } else {
  ...
  Actor.cl = function(targetClasses) {
    var className, g, l, len, len1, m, ref, results, tc, tcs;
    ...
    tcs = targetClasses instanceof Array ? targetClasses : [targetClasses];
    results = [];
    for (m = 0, len1 = tcs.length; m < len1; m++) {
      tc = tcs[m];
  ...
  Actor.prototype.oc = function(targetClass, handler) {
    var cca, collideCheckedActors, isCollided, l, len;
    if (handler == null) {
      handler = null;
    }
    isCollided = false;
    collideCheckedActors = Actor.s(targetClass);
    for (l = 0, len = collideCheckedActors.length; l < len; l++) {
      cca = collideCheckedActors[l];
  ...
  function Actor() {
    var args, className, g, l, len, ref;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
...
Drawing = (function() {
  ...
  Drawing.prototype.c = function(color1) {
    this.color = color1;
    return this;
  };
  ...
  Drawing.prototype.rt = function(angle, number) {
    ...
    for (i = l = 1, ref = number; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
      o.rt(angle);
  ...
  Drawing.prototype.isCollided = function(d) {
    var dr, isCollided, l, len, len1, m, r, ref, ref1;
    isCollided = false;
    ref = this.s;
    for (l = 0, len = ref.length; l < len; l++) {
      r = ref[l];
...
DrawingRect = (function() {
  function DrawingRect(color1, width, height, ox, oy, hasCollision) {
    this.color = color1;
...
TextActor = (function(superClass) {
  extend(TextActor, superClass);
...
Letter = (function() {
  ...
  Letter.initialize = function() {
    var c, charStr, ci, d, dots, i, j, k, l, li, m, p, pIndex, patterns, q, ref, results, u;
    this.COUNT = 66;
    ...
    pIndex = 0;
    this.dotPatterns = [];
    for (i = l = 1, ref = this.COUNT; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
      dots = [];
      for (j = m = 1; m <= 5; j = ++m) {
        for (k = q = 1; q <= 4; k = ++q) {
          if (++d >= 32) {
    ...
    for (c = u = 0; u <= 127; c = ++u) {
      ...
      results.push(this.charToIndex.push(li));
    }
    return results;
  };
...
Particle = (function() {
  ...
  Particle.prototype.p = function(pos1) {
    this.pos = pos1;
    return this;
  };
  ...
  Particle.prototype.n = function(number1) {
    this.number = number1;
    return this;
  };
  ...
  Particle.prototype.w = function(way1, wayWidth) {
    this.way = way1;
  ...
  Particle.prototype.s = function(speed1) {
    this.speed = speed1;
    return this;
  };
  ...
  Particle.prototype.c = function(color1) {
    this.color = color1;
    return this;
  };
  ...
  Particle.prototype.sz = function(size1) {
    this.size = size1;
    return this;
  };
  ...
  Particle.prototype.d = function(duration1) {
...
ParticleActor = (function(superClass) {
  extend(ParticleActor, superClass);
  ...
  ParticleActor.prototype.update = function() {
    ...
    if (this.particle != null) {
      ...
      ww = pp.wayWidth / 2;
      for (i = l = 1, ref = pp.number; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
        p = new ParticleActor;
        p.p.v(pp.pos);
...
Sound = (function() {
  ...
  Sound.prototype.pt = function(pattern, patternInterval1) {
    this.pattern = pattern;
    this.patternInterval = patternInterval1 != null ? patternInterval1 : 0.25;
    return this;
  };
  ...
  Sound.generateParam = function(seed, params, mixRatio) {
    var ci, cp, i, l, p, pl, psl, random, ref, rt;
    if (mixRatio == null) {
      mixRatio = 0.5;
    }
    ...
    while (random.r() < mixRatio) {
      ...
      cp = params[ci];
      for (i = l = 1, ref = pl - 1; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
        rt = random.r();
  ...
  Sound.initialize = function() {
    ...
    return this.isDummyPlayed = false;
  };
  ...
  Sound.generateDrumPattern = function(seed) {
    var c, cd, cdp, ci, d, dp, dpa, dpl, dpsl, gdp, i, l, len, m, q, random, ref, ref1;
    random = seed !== 0 ? new Random(seed) : this.random;
    ...
    dpl = dp.length;
    dpa = [];
    for (i = l = 0, ref = dpl - 1; 0 <= ref ? l <= ref : l >= ref; i = 0 <= ref ? ++l : --l) {
      d = dp.charAt(i);
    ...
    while (random.r() < .5) {
      ...
      for (i = m = 0, ref1 = dpl - 1; 0 <= ref1 ? m <= ref1 : m >= ref1; i = 0 <= ref1 ? ++m : --m) {
        cd = cdp.charAt(i);
        c = cd === '1' ? true : false;
        dpa[i] = (!dpa[i]) !== (!c);
      }
    ...
    gdp = '';
    for (q = 0, len = dpa.length; q < len; q++) {
      d = dpa[q];
      gdp += d ? '1' : '0';
    }
    return gdp;
  ...
  Sound.playDummy = function() {
    var s;
    if (!this.isEnabled || this.isDummyPlayed) {
      return;
    }
    this.isDummyPlayed = true;
    s = this.c.createBufferSource();
    s.buffer = WebAudiox.getBufferFromJsfx(this.c, this.drumParams[0]);
    s.start = s.start || s.noteOn;
    s.start(0);
    s.onended = function() {
      return s.disconnect();
    };
    return s.connect(this.gn);
  };
...
Vector = (function() {
  ...
  Vector.prototype.xy = function(x1, y1) {
    this.x = x1 != null ? x1 : 0;
    this.y = y1 != null ? y1 : 0;
    return this;
  };
  ...
  Vector.prototype.ii = function(spacing, minX, maxX, minY, maxY) {
    ...
    return (minX - spacing <= (ref = this.x) && ref <= maxX + spacing) && (minY - spacing <= (ref1 = this.y) && ref1 <= maxY + spacing);
  };
